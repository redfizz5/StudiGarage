 ...
 */
final class Version20230718115039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, online TINYINT(1) NOT NULL, subtitle VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, create_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, attachment VARCHAR(255) NOT NULL, INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
